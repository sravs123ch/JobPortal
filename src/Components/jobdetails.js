...
// export const JobDetails = (isNavbarOpen) => {
...
import { jobs } from "./jobapplication";
      ...
      {companyJobs.map((job) => (
        ...
        >
          ...
          <div className="mb-4">
            <h4 className="text-xl font-semibold mb-2">Job Description:</h4>
            <p>
              We are seeking two Senior Software Development Engineers in Test
              (SDETs). You will be responsible for finding, analyzing, and
              reporting defects and other software issues. Your primary focus
              will be manual testing as well as automated testing. The
              successful candidate possesses a strong sense of curiosity,
              demonstrates attention to detail, problem-solving skills, and an
              interest in continuous learning.
              <br />
              <br />
              5+ years experience with object-oriented programming languages and
              techniques C#, Java, or TypeScript.
              <br />
              <br />
              5+ years of experience developing and maintaining test automation
              for Web & Mobile Applications and backend test automation.
            </p>
          </div>
          ...
          <div className="mb-4">
            ...
            <ul className="list-disc pl-5">
              <li>
                Work closely and collaboratively with engineers and product
                managers to ensure the delivery of the high-quality product.
              </li>
              <li>
                Improve the customers’ experiences by understanding what’s
                important, measuring how we’re doing, and driving testing
                priorities to improve.
              </li>
              <li>
                Actively participate in team sprint planning and refinement
                meetings.
              </li>
              <li>
                Perform functional, regression, and smoke testing on new
                features.
              </li>
            </ul>
          </div>
