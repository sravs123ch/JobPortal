...
export const  JobsList  = (isNavbarOpen) => {
...
<div className="w-full xl:w-3/4 flex justify-between space-x-8 mb-4 ml-40 items-center">
  {/* Country Dropdown */}
  <div className="w-1/2">
  ...
  className="py-2 px-4 inline-flex items-center justify-center space-x-2 rounded-md bg-indigo-600 text-white shadow-sm hover:bg-indigo-700"
>
  <FaPlus aria-hidden="true" className="h-5 w-5" />
  <span className="text-sm font-medium">AddJobs</span>
</button>
